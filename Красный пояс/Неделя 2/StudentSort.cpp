// StudentSort.cpp: определяет точку входа для консольного приложения.
//
...
// убрал копирование структур - было 1 ms стало 0 ms
...
void TestSorting() {
	...
	ASSERT(is_sorted(students.begin(), students.end(), Compare));
}
